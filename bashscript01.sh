...
#for multiline comment in shell script
<<COMMENT
This is Multipleline of comment in shell script.
You can multiple lines like this in shell script.
it act as a block comment and wont be execute.
COMMENT

echo "==============================================================================================================================================="
#Task_2: Variables
#Declaaring the arthematic variable in shell script
num1=10
num2=14
sum=$((num1 + num2))
